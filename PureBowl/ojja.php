...
?>
    ...
    <main class="container">
      ...
      <div class="column">
      	...
      	<br>
      	<br>
            <img src="images/img-06.jpg" alt="" width="500"> 
      ...
      <div class="right-column">
        ...
        <div class="product-price">
          ...
          <p> It is often made with a spicy lamb sausage known as merguez,but it can just as easily be made vegetarian.</p>
        </div>
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <input id="dish" class="form-control" name="dish" required="" placeholder="Please enter your dish"type="hidden" value="Ojja" required data-error="??">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <select class="custom-select d-block form-control" name="meat" id="meat" required="" required data-error="Please select your prefered meat">
                   ...
                   <div class="col-md-12">
                    <div class="form-group">
                      <select class="custom-select d-block form-control"  name="option" id="option" required="" required data-error="Please select the options">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <select class="custom-select d-block form-control" required="" name="person" id="person" required data-error="Please select the number of people">
