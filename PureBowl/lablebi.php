...
?>
    ...
    <main class="container">
      ...
      <div class="column">
      	...
      	<br>
      	<br>
            <img src="images/img-02.jpg" alt="" width="500"> 
      ...
      <div class="right-column">
        ...
        <div class="product-price">
          ...
          <p> Lablabi is a Tunisian dish based on chick peas in a thin garlic and cumin-flavoured broth, served over small pieces of stale crusty bread. </p>
        </div>
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <input id="dish" class="form-control" name="dish"  placeholder="Please enter your dish"type="hidden" value="Lablebi" >
