...
<h1>Send a mail to your loved ones 💗</h1>
	...
	<div>
		<input type="text" name="sub" id="sub" class="form-control"  value="NEW PACK ALERT!" readonly required autofocus>
	</div><br>
	<div>
		<?php
		 $offreC = new offreC();
    ...
    ?>
		...
		<input name="msg" id="msg" class="form-control"  value=" go check purebowl new pack  <?php echo $offer['nom_offre'];?> on their website it costs <?php echo $offer['prix_offre'];?> dollar and  it has <?php echo $offer['descrip_offre'];?> " readonly required autofocus>
			 <?php
		}
		 ?>
