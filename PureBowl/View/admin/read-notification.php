...
require_once $_SERVER['DOCUMENT_ROOT'].'/PureBowl/PureBowl/Controller/NotificationC.php';
    ...
    /* Mise à jour de Notification (status = 1 : readed)*/
    NotificationC::updateNotificationById($_GET['id']);

    /* Afficher le message de l'id passer en parametre*/
    $notification = NotificationC::displayNotificationById($_GET['id']);
...
<head>
    ...
    <title>View Comment - Dashboard HTML Template</title>
    <link
            rel="stylesheet"
    ...
    <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
            <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                <div class="row">
                    <div class="col-12">
                        <h2 class="tm-block-title d-inline-block">View Comment</h2>
                        <?php echo '<p style="color:yellow;font-size:12px;font-family:monospace">'.$notification['time'].'</p>' ?>
                    </div>
                </div>
                        ...
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" class="tm-edit-delivery-form" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea
                                        ...
                                        rows="5"
                                        style="height: 150px;background-color: #54657d;!important;"
                                        readonly
                                        >
