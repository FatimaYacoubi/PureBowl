                      ...
                      <a href="affichercommande.php"><h3  align="center" style="color: orange;">Back</h3></a>
                          <thead>  
                               <tr>  
                                    ...
                                    <td style=" color: white; font-size: 20px;">Dish</td>  
                                    <td style=" color: white; font-size: 20px;">Meat</td>
                                    <td style=" color: white; font-size: 20px;">Option</td>  
                               </tr>  
                          </thead>  
                          <?php  
                          ...
                          {  
                               ...
                               <tr>  
                                    ...
                                    <td style="background-color: #4e657a;color: white;; font-size: 18px;" class="text-white mt-5 mb-5">'.$row["dish"].'</td>  
                                    <td style="background-color: #4e657a;color: white;; font-size: 18px;" class="text-white mt-5 mb-5">'.$row["meat"].'</td>  
                                    <td style="background-color: #4e657a;color: white;; font-size: 18px;" class="text-white mt-5 mb-5">'.$row["option"].'</td>  
                               </tr>  
                               ';  
                          }  
                          ?>  
