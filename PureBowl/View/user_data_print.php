  ...
  <div class="row">
   ...
   <div class="recipe_detail clearfix">
     <div class="col-sm-12">
	   ...
	   <h3 class="text-center">Name of the dish</h3>
	 </div>
   </div>
  ...
  <div class="row">
   ...
   <div class="col-sm-12">
    ...
    <div class="col-sm-3">
	 ...
	 <h5 class="text-center heading_tag_1">SEND TO A FRIEND</h5>
     <div class="contact_icon contact_icon_detail text-center clearfix">
					<ul class="social-network social-circle">
						<li><a href="#" class="icoRss" title="Rss"><i class="fa fa-instagram"></i></a></li>
    ...
    <div class="col-sm-3">
	 ...
	 <h5 class="text-center heading_tag_1">UPLOAD</h5>
     <div class="contact_icon contact_icon_detail text-center clearfix">
					<ul class="social-network social-circle">
						<li><a href="#" class="icoRss" title="Rss"><i class="fa fa-instagram"></i></a></li>
   ...
   <!--<div class="col-sm-12">
    <div class="store_3"><p class="company-name">All Rights Reserved. &copy; 2018 <a href="#">Yamifood Restaurant</a> Design By : 
					<a href="https://html.design/">html design</a></p></div>
   </div>
  </div>--->
 </div>
    </section>
